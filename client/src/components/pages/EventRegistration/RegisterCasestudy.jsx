...
export default function RegisterCasestudy() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        console.log(registerCasestudyData)

        // try {
        //     await axios.post("/auth/register",  registerCasestudyData )
        //     console.log(registerCasestudyData)
                ...
                <div className="d-table-cell">
                    <div className="signup-form">
                        ...
                        <form>
                            ...
                            <p>Already registered for Casestudy? <Link to="/login">Login!</Link></p>
                        </form>
                    </div>
                </div>
            </div>
